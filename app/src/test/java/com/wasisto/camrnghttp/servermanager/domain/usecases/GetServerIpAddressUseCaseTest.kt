...
class GetServerIpAddressUseCaseTest {
    ...
    fun setUp() {
        ...
        getServerIpAddressUseCase = GetServerIpAddressUseCase(server)
    }
    ...
    fun testInvoke() {
        ...
        every { server.getIpAddress() }.returns(serverIpAddress)

        assertEquals(serverIpAddress, getServerIpAddressUseCase())

        verify { server.getIpAddress() }
    }
}